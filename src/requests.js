...
const SEARCH_API = `https://api.themoviedb.org/3/search/movie?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&page=1&include_adult=false`
...
const requests = {
    ...
    fetchList: `/list/{list_id}?api_key=${process.env.REACT_APP_API_KEY}&language=en-US`,
    postList: `/list?api_key=${process.env.REACT_APP_API_KEY}`
}
